<nav x-data="{ open: false }" class="border-b border-gray-100" style="background-color: #3730a3">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <p class="text-white">Pro<strong>ES</strong></p>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-black bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="inline-flex items-center">
                                <img src="{{ asset('storage/' . Auth::user()->avatar_cabeca) }}" class="w-5" style="margin-right: 1em">
                                {{ Auth::user()->name }}
                            </div>
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('conquistas.index')">
                            {{ __('Conquistas') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('loja.index')" :active="request()->routeIs('loja*')">
                {{ __('Loja') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('colecao.index')" :active="request()->routeIs('colecao*')">
                {{ __('Minha coleção') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('conquistas.index')">
                    {{ __('Conquistas') }}
                </x-responsive-nav-link>
