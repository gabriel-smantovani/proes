<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('Senha')" style="color: #f3f4f6"/>
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" :value="__('Confirme a senha')" style="color: #f3f4f6"/>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-4" style="background-color: #3730a3">
                {{ __('Cadastrar') }}
            </x-primary-button>
        </div>
    </form>
